...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("TheMermaidCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("TheMermaidCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("TheMermaidCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TheMermaidCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
		    	{"mermaid.ddns.net", "mermaid.ddns.net"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("TheMermaidCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("TheMermaidCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("TheMermaidCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("TheMermaidCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TheMermaidCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("TheMermaidCoin-start");
